...
<p>Точечная сварка на аккумуляторов 18650 на ардуино нано. Длительность импульсов (в миллисекундах) настраивается с помощью потенциометра и отображается на экране</a></p>
